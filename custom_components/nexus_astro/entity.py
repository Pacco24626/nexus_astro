"""Classe base delle entita' di un gruppo."""
...
class AstroEntity(Entity):
    """Entita' agganciata al controller del gruppo."""

    _attr_has_entity_name = True
    _attr_should_poll = False

    def __init__(self, controller: AstroController, chiave: str) -> None:
